...
namespace RedJasmine\FilamentSupport\Forms\Fields;
...
class MoneyInput extends Field
{
    ...
    protected string $view = 'red-jasmine-filament-support::forms.fields.money';
    ...
    public static function getCurrenciesCodes() : array
    {
        ...
        foreach ($currencies->getIterator() as $currency) {
            $currenciesCodes[$currency->getCode()] =
                $currency->getCode().'('.$currencies->getSymbol($currency).'-'. $currencies->getName($currency).')';
        }
